...
function Volunteer() {
    ...
    const fallback = <span>An easy way to get involved is to come to our monthly volunteer nights!
    ...
    You are welcome to submit information about your volunteer interests and availability in the form below.</span>

    return (
        <div className='outer-container'>
        <div className="inner-container">
            <TemplateFormPage content={content} heading={heading} query={VOLUNTEER_QUERY} fallBackHeading={'Public Service Announcements'} FallBackBody={fallback} />
        </div>
    </div>
    );
}
